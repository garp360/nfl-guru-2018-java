...
import hb.nflguru.importer.MasseyPredictionsImporter;
...
public class PastResultsImporter_TEST
{
	...
	{
		HistoricalDataImporter historicalDataImporter = new HistoricalDataImporter();

		// PastResultsImporter importer = new PastResultsImporter();
		String outputFilePath = "/Users/garthpidcock/Downloads/nflGuruDataArchive.json";
	...
	@Test
	public void testMasseyImporter()
	{
		MasseyPredictionsImporter i = new MasseyPredictionsImporter();
		Map<String, Integer> importResults = i.importResults();
		System.out.println(importResults);

	}

	@Test
	public void testAdvancedPredictor()
	{
		AdvancedPredictor advancedPredictor = new AdvancedPredictor();
	...
	public void testCurrentSeasonImporter()
	{
		...
		// String outputFilePath = "./data/nflGuruDataCurrentSeasonWeek%s.json";
	...
	{
		String historicalDataFilePath = "/Users/garthpidcock/git/nflguru2018/nflguru2018/data/nflGuruDataArchive%s.json";
